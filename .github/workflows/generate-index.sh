...
SigLevel = Optional TrustAll</code></pre>
        ...
        <h2>Install ZFS</h2>
        <p>Install both ZFS utilities and kernel modules:</p>
        <pre><code>sudo pacman -S zfs-utils zfs-linux-zen</code></pre>
        ...
        <p>Packages are automatically rebuilt when either ZFS or the linux-zen kernel is updated (checked every 6 hours).</p>

        <h2>Source Code</h2>
        <p>Repository source and PKGBUILD files: <a href="https://github.com/jasonthagerty/zfs-linux-zen">github.com/jasonthagerty/zfs-linux-zen</a></p>
